...
var apiKey = 'qSYA_w.krlLyA:LwX6c2BpQZVkBVUyvNpf4lOuz0W-J8xrmI7yAzi2UWI' // Note : Plz use your own API key in ably website
...
AblyRealtime.subscribe(`incoming-call/${clientId}`, call => {
    ...
    var isAccepted = confirm(`Do you want to enable voice chat?`)
    if (!isAccepted) {
